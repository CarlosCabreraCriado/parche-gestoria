    ...
    subCategoria: [
      {
        ...
        argumentos: [
          ...
          },
          {
            tipo: "texto",
            obligado: false,
            identificador: "art42EmpresaRegimen",
            formulario: {
              titulo: "Art.42 — Régimen empresa autorizada",
              tipo: "texto",
              placeholder: "Ej: 0111",
              valorDefault: "",
              mostrarSi: { indice: 3, valor: true },
          ...
          },
          {
            tipo: "texto",
            obligado: false,
            identificador: "art42EmpresaTesoreria",
            formulario: {
              titulo: "Art.42 — Tesorería empresa autorizada",
              tipo: "texto",
              placeholder: "Ej: 38",
              valorDefault: "",
              mostrarSi: { indice: 3, valor: true },
          ...
          },
          {
            tipo: "texto",
            obligado: false,
            identificador: "art42EmpresaCuenta",
            formulario: {
              titulo: "Art.42 — Cuenta empresa autorizada",
              tipo: "texto",
      ...
      {
        nombre: "Certificado AEAT",
        categoria: "Certificados",
        tipo: "proceso",
        descripcion: "Descarga certificado tributario AEAT",
        autor: "Carlos Cabrera",
        argumentos: [
          {
            tipo: "texto",
